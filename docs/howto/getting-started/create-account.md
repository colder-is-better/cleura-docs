...
![Type in necessary details](assets/02-type-email-country_light.png#only-light)
![Type in necessary details](assets/02-type-email-country_dark.png#only-dark)
...
![Three steps to take](assets/03-step-1_light.png#only-light)
![Three steps to take](assets/03-step-1_dark.png#only-dark)
...
![Three steps to take](assets/04-conf-email_light.png#only-light)
![Three steps to take](assets/04-conf-email_dark.png#only-dark)
...
![Confirm account information](assets/05-step-2_light.png#only-light)
![Confirm account information](assets/05-step-2_dark.png#only-dark)
...
![Account verification](assets/06-step-3_light.png#only-light)
![Account verification](assets/06-step-3_dark.png#only-dark)
