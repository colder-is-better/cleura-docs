...
![Request the deletion of Grafana](assets/delete-grafana/grafana-delete-01_light.png#only-light)
![Request the deletion of Grafana](assets/delete-grafana/grafana-delete-01_dark.png#only-dark)
...
![Make sure you are about to delete Grafana](assets/delete-grafana/grafana-delete-02_light.png#only-light)
![Make sure you are about to delete Grafana](assets/delete-grafana/grafana-delete-02_dark.png#only-dark)
...
![Grafana is deleted](assets/delete-grafana/grafana-delete-03_light.png#only-light)
![Grafana is deleted](assets/delete-grafana/grafana-delete-03_dark.png#only-dark)
