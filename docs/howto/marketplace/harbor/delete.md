...
![Request the deletion of Harbor](assets/delete-harbor/harbor-delete-01_light.png#only-light)
![Request the deletion of Harbor](assets/delete-harbor/harbor-delete-01_dark.png#only-dark)
...
![Make sure you are about to delete Harbor](assets/delete-harbor/harbor-delete-02_light.png#only-light)
![Make sure you are about to delete Harbor](assets/delete-harbor/harbor-delete-02_dark.png#only-dark)
