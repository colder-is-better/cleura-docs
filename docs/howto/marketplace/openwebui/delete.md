...
![Request the deletion of Open WebUI](assets/delete-openwebui/openwebui-delete-01_light.png#only-light)
![Request the deletion of Open WebUI](assets/delete-openwebui/openwebui-delete-01_dark.png#only-dark)
...
![Make sure you are about to delete Open WebUI](assets/delete-openwebui/openwebui-delete-02_light.png#only-light)
![Make sure you are about to delete Open WebUI](assets/delete-openwebui/openwebui-delete-02_dark.png#only-dark)
...
![Open WebUI is deleted](assets/delete-openwebui/openwebui-delete-03_light.png#only-light)
![Open WebUI is deleted](assets/delete-openwebui/openwebui-delete-03_dark.png#only-dark)
