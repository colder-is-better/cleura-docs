...
![Specify the characteristics of the particular Open WebUI deployment](assets/new-openwebui/openwebui-03_light.png#only-light)
![Specify the characteristics of the particular Open WebUI deployment](assets/new-openwebui/openwebui-03_dark.png#only-dark)
...
![Locate the Open WebUI public URL](assets/new-openwebui/openwebui-dashboard-01_light.png#only-light)
![Locate the Open WebUI public URL](assets/new-openwebui/openwebui-dashboard-01_dark.png#only-dark)
...
![Copy the Open WebUI public URL](assets/new-openwebui/openwebui-dashboard-02_light.png#only-light)
![Copy the Open WebUI public URL](assets/new-openwebui/openwebui-dashboard-02_dark.png#only-dark)
...
![Create a new admin user](assets/new-openwebui/openwebui-dashboard-04_light.png#only-light)
![Create a new admin user](assets/new-openwebui/openwebui-dashboard-04_dark.png#only-dark)
...
![The Open WebUI dashboard](assets/new-openwebui/openwebui-dashboard-05_light.png#only-light)
![The Open WebUI dashboard](assets/new-openwebui/openwebui-dashboard-05_dark.png#only-dark)
